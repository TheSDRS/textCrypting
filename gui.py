...
frm = tk.Frame(root, padx=10, pady=10, background="yellow")
frm.grid()

keyContainer = tk.Frame(frm, background="deep sky blue", padx=10, pady=10)
...
keyActionsContainer = tk.Frame(frm, background="red", padx=10, pady=10)
...
textContainer = tk.Frame(frm, background="green", padx=10, pady=10)
...
fileContainer = tk.Frame(frm, background="blue", padx=10, pady=10)
...
actionContainer = tk.Frame(frm, background="gray", padx=10, pady=10)
